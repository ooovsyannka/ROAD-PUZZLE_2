...
{
    [SerializeField] private List<UniversalRoadNode> _universalRoadNodes;
    ...
    private UniversalRoadNode _currentUniversalStartRoad;
    private UniversalRoadNode _brokeUniversalRoad;
    ...
    {
        if (iFinishRoad is UniversalRoadNode universalFinishRoad)
        {
    ...
    private void TryFinidhGame(Road _)
    {
    ...
    private void TryBrokeUniversalFinishRoad()
    {
        ...
        {
            UniversalRoadNode randomUniversalRoadNode = _universalRoadNodes[Random.Range(0, _universalRoadNodes.Count)];

            if (randomUniversalRoadNode.RoadNodeType == RoadNodeType.Finish)
            {
                randomUniversalRoadNode.Broken();
                _brokeUniversalRoad = randomUniversalRoadNode;
            }
        }
    }
